"""
test_data.py — Populate the database with 2 sample bills for development/testing.
...
from database import init_db, get_db, generate_bill_number
...
SAMPLE_BILLS = [
    {
        ...
        "payments": [
            {"payment_method": "Cash", "amount": None},  # filled in after total computed
        ],
    },
    {
        ...
        "payments": [
            ...
            {"payment_method": "UPI",  "amount": None},   # filled in after total computed
        ],
    },
]
...
def resolve_payments(payments, final_total):
    """Fill in the None amount as the remainder."""
...
def insert_bill(db, bill_data):
    ...
    customer_mobile = bill_data["customer_mobile"]  # already 10 digits in test data
    ...
    # Generate bill number and insert everything, then commit
