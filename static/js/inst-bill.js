...
function addInstItem() {
  ...
  tr.innerHTML = `
    ...
    <td>
      <button class="inst-del-btn" onclick="removeInstItem(${id})" title="Remove" aria-label="Remove item"><svg class="ico" aria-hidden="true"><use href="#i-x"/></svg></button>
    </td>
  `;
...
async function populateInstItemForEdit(item) {
  ...
  tr.innerHTML = `
    ...
    <td><button class="inst-del-btn" onclick="removeInstItem(${id})" title="Remove" aria-label="Remove item"><svg class="ico" aria-hidden="true"><use href="#i-x"/></svg></button></td>
  `;
  tbody.appendChild(tr);
