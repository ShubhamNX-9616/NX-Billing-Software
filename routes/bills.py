...
# ---------------------------------------------------------------------------
@bills_bp.route("/export/bills", methods=["GET"])
@api_admin_required
def export_bills():
    try:
        ...
        # Data rows — accumulate column totals while writing
        DATA_START = HDR_ROW + 1
        col_totals = [0.0] * NUM_COLS  # index 0 = col 1
        ...
        # Totals row — write pre-computed sums as plain numbers
